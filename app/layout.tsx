...
export const metadata = {
  ...
  description: "Christian Junior Full Stack Developer Portfolio Website",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-20 sm:pt-28 dark:bg-slate-900 dark:text-gray-50 dark:text-opacity-90`}
      >
